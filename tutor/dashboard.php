...
<div class="tutor-wrap tutor-dashboard tutor-frontend-dashboard tutor-dashboard-student tutor-pb-80 mt-5 mb-2">
			...
			<div class="tutor-col-12 tutor-col-md-4 tutor-col-lg-3 tutor-dashboard-left-menu">
				<ul class="tutor-dashboard-permalinks">
					...
					foreach ($dashboard_pages as $dashboard_key => $dashboard_page) {
						...
						if ($separator) {
							echo '<li class="tutor-dashboard-menu-divider d-none"></li>';
							if ($menu_title) {
							...
							if($menu_title == "Reviews") continue;
