...
<?php else : ?>
    ...
    <div class="signup-form-wrapper py-5 px-3 px-md-0">
        <form method="post" enctype="multipart/form-data" id="tutor-registration-from">
            ...
            <div class="tutor-form-row">
                <div class="tutor-form-col-12">
                    <div class="tutor-form-group tutor-reg-form-btn-wrap mt-4">
                        <button type="submit" name="tutor_register_student_btn" value="register" class="btn btn-primary py-3"><?php _e('Register', 'tutor'); ?></button>
                    </div>
                </div>
            </div>
        </form>
