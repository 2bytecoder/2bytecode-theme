		...
		if ( $is_enrolled || $is_privileged_user) {
			...
			<?php if ( tutor_utils()->get_option('enable_course_progress_bar', true, true) && is_array( $course_progress ) && count( $course_progress ) ) : ?>
				<div class="tutor-course-progress-wrapper tutor-mb-32">
					<h3 class="text-dark tutor-fs-5 tutor-fw-bold tutor-mb-16">
			...
			if ( $lesson_url ) {
				$button_class = 'tutor-is-fullwidth btn btn-primary w-100 py-3' .
				...
				<div class="d-flex justify-content-center">
					<<?php echo $tag; ?> <?php echo $retake_course ? 'disabled="disabled"' : ''; ?> href="<?php echo esc_url( $lesson_url ); ?>" class="<?php echo esc_attr( $button_class . ' ' . $button_identifier ); ?>" data-course_id="<?php echo esc_attr( get_the_ID() ); ?>" style="max-width: 400px;">
					<?php
					if ( $retake_course ) {
			...
			if ( ! $is_completed_course ) {
				...
				<form method="post" class="tutor-mt-20">
					...
					<div class="d-flex justify-content-center">
					<button type="submit" class="btn btn-primary py-3 w-100 tutor-btn-lg tutor-btn-full" name="complete_course_btn" value="complete_course" style="max-width: 400px;">
			...
			?>
			<div class="d-flex justify-content-center">
				<a href="<?php echo esc_url( $first_lesson_url ); ?>" class="btn btn-primary py-3 w-100 tutor-btn-full" style="max-width: 400px;">
			...
			if ( tutor_utils()->is_course_fully_booked( null ) ) {
				...
				?>
					<div class="tutor-course-sidebar-card-pricing tutor-d-flex tutor-align-items-end tutor-justify-content-between">
						<div>
							<span class="tutor-fs-4 tutor-fw-bold tutor-color-black text-dark">
					...
					<div class="tutor-course-sidebar-card-btns <?php echo is_user_logged_in() ? '' : 'tutor-course-entry-box-login'; ?>" data-login_url="<?php echo $login_url; ?>">
						<form class="tutor-enrol-course-form" method="post">
							...
							<div class="d-flex justify-content-center">
							<button type="submit" class="btn btn-primary w-100 py-3 tutor-mt-24 tutor-enroll-course-button" style="max-width: 400px;">
