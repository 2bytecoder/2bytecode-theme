<div class="quiz-meta-info tutor-d-flex tutor-justify-content-between flex-column flex-md-row">
	<div class="quiz-meta-info-left tutor-d-flex flex-column flex-md-row">
		<?php
		...
		<div class="quiz-meta-info-right">
			<div class="quiz-time-remaining tutor-d-flex">
				<?php if ( $remaining_time_secs > 0 ) : ?>
					<div class="quiz-time-remaining-progress-circle d-none">
				...
				<?php if ( $remaining_time_secs < 0 ) : ?>
					<div class="quiz-time-remaining-expired-circle d-none">
						<svg viewBox="0 0 50 50" width="50" height="50">
