...
?>
    ...
    <div class="tutor-single-page-top-bar tutor-d-flex tutor-justify-content-between d-none">
    ...
    <div class="tutor-mobile-top-navigation tutor-d-block tutor-d-sm-none tutor-my-20 tutor-mx-12 d-none">
	...
	<?php ob_start(); ?>
		<div class="tutor-quiz-wrapper tutor-quiz-wrapper tutor-d-flex tutor-justify-content-left tutor-mt-80 tutor-pb-80 mt-5 ps-4">
			<input type="hidden" name="tutor_quiz_id" id="tutor_quiz_id" value="<?php the_ID(); ?>">
